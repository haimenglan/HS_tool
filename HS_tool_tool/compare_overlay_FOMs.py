...
class My_xlwt:
   ...
   def write_compare_data_result(self,compare_fom_obj):
      ...
      if por_station_name == new_station_name:
         save_path = self.xls_file_path+"/"+ por_station_name+"_"+por_version+"_VS_"+new_version+".xls"
      else:
         save_path = self.xls_file_path+"/"+ por_station_name+"_"+por_version+"_VS_"+ new_station_name+"_"+new_version+".xls"

      self.xls_book.save(save_path)
      print("\033[1;34mResult file have saved at \033[1;32m %s\033[0m"%(save_path))
